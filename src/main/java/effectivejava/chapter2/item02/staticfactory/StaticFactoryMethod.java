...
public class StaticFactoryMethod {
	...
	/**
	 * In cases where a class seems to require multiple constructors with the same signature, replace the constructors with static
	 * factory methods and carefully chosen names to highlight their differences.
	 * For example constructor BigInteger(int, int, Random), which returns a BigInteger that is

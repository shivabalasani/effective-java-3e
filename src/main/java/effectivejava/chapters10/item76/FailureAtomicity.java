package effectivejava.chapters10.item76;
 ...
 * free. If an operation fails, it may prevent a new object from getting
 * created, but it will never leave an existing object in an inconsistent state,
 * because the state of each object is consistent when it is created and can’t
 ...
 * ArrayIndexOutOf- BoundsException thrown by the pop method would be

package effectivejava.chapters10.item73;
 ...
 * disconcerting, but it pollutes the API of the higher layer with
 * implementation details. If the implementation of the higher layer changes in
 * a later release, the exceptions it throws will change too, potentially
 * breaking existing client programs.
 * 
 * To avoid this problem, higher layers should catch lower-level exceptions and,
 * in their place, throw exceptions that can be explained in terms of the
 * higher-level abstraction. This idiom is known as exception translation:
 * 
 * // Exception Translation
 * 
 * try { ... // Use lower-level abstraction to do our bidding } catch
 * (LowerLevelException e) { throw new HigherLevelException(...); }
 * 
 * Below is an example of exception translation taken from the
 ...
 * 
 * try { ... // Use lower-level abstraction to do our bidding } catch
 * (LowerLevelException cause) { throw new HigherLevelException(cause); }
 * 
 ...
 * chainingaware constructors, such as Throwable(Throwable):
 * 
 * // Exception with chaining-aware constructor
 * 
 * class HigherLevelException extends Exception { HigherLevelException(Throwable
 * cause) { super(cause); } }
 * 
